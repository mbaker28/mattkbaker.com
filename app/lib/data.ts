...
export const projects: Project[] = [
	...
	},
	{
		...
		description: `A simple URL Shortener app written with <a href="https://symfony.com" class="no-underline hover:text-[color:var(--link-color)]" target="_blank">Symfony</a>.`,
		image: {
